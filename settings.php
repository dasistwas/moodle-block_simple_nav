...
if ($ADMIN->fulltree) {
	...
	$defaultsetting = 1;
	$choices = array(1 => get_string('displaywithicons', 'block_simple_nav'), 2 => get_string('displaysingleicon', 'block_simple_nav'), 3 => get_string('displaytwoicons', 'block_simple_nav'));
